...
namespace MITD.PMS.Interface
{
    public class MethodMapper
    {
        ...
        private readonly List<MethodAction> mapTable = new List<MethodAction>
        {
            ...
            //    new List<ActionType> {ActionType.ManageJobInPeriod}),
            ...
            //    new List<ActionType> {ActionType.CreateFunction}),
            //new MethodAction(typeof (IFunctionFacadeService).Name,
            ...
            //    new List<ActionType> {ActionType.CreateCustomField}),
            //new MethodAction(typeof (ICustomFieldFacadeService).Name,
            ...
            //    new List<ActionType> {ActionType.CreateJob}),
            ...
            //    new List<ActionType> {ActionType.ModifyJob, ActionType.ModifyJobCustomFields}),
