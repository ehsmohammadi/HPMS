...
{
    [Profile("Test")]
    public class IRISLSeedDataForTest : Migration
    {
        ...
        ");
                ...
                AdminMigrationUtility.CreateRule(ruleRep, "محاسبه شاخص های کارمندان در دور اول", RuleType.PerCalculation,
                    1, @"
           if (data.PathNo != 1) return;
            ...
            ");
                ...
                AdminMigrationUtility.CreateRule(ruleRep, "محاسبه شاخص های کارمندان در دور دوم", RuleType.PerCalculation,
                    3, @"
           if (data.PathNo != 2) return;
            ...
            using (var uow = uows.CurrentUnitOfWork as NHUnitOfWork)
            {
                ...
                AdminMigrationUtility.CreateUnitIndex(unitIndexRep, "تحقق برنامه های راهبردی",
                    "RealizationOfStrategicPlans");
                AdminMigrationUtility.CreateUnitIndex(unitIndexRep, "تحقق برنامه های عملیاتی",
                    "RealizationOfOperationalPlans");
                ...
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر شرکت حمل کانتینری",
                    "ContinerTransportationCompanyManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر شرکت حمل فله",
                    "BulkTransportationCompanyManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر معاونت مالی", "FinancialDepartmentManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر معاونت اداری",
                    "AdministrativeDepartmentManager");

                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر دفتر تشکیلات", "OfficeOrganizationManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر امور کارکنان",
                    "PersonnelDepartmentManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر اداره تربیت بدنی",
                    "PhysicalEducationOfficeManager");

                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر امور پشتیبانی", "SupportDepartmentManager");

                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر واحد تحویل و ترخیص",
                    "DeleiveryAndClearanceManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "کارمند واحد تحویل و ترخیص",
                    "DeleiveryAndClearanceEmployee");

                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر واحد ثبت و طبقه بندی اسناد و مدارک",
                    "RecordedAndClassifiedDocumentsManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "کارمند واحد ثبت و طبقه بندی اسناد و مدارک",
                    "RecordedAndClassifiedDocumentsEmployee");

                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "مدیر واحد پشتیبانی و خدمات",
                    "SupportAndServicesManager");
                AdminMigrationUtility.CreateJobPosition(jobPositionRep, "کارمند واحد پشتیبانی و خدمات",
                ...
                AdminMigrationUtility.CreateJobIndex(jobIndexRep, "مشارکت برنامه های راهبردی",
                    "PartnershipOfStrategicPlans", performanceGroupStr);
                AdminMigrationUtility.CreateJobIndex(jobIndexRep, "مشارکت برنامه های عملیاتی",
                    "PartnershipOfOperationalPlans", performanceGroupStr);
                AdminMigrationUtility.CreateJobIndex(jobIndexRep, "بهره گیری از سیستم اتوماسیون",
                    "utilizationFromAutomation", performanceGroupStr);
                ...
                AdminMigrationUtility.CreatePolicy(policyRep, "روش دفتر برنامه ها و روش ها",
                    "MethodsAndPlanOfficePolicy");
