...
{
    [Profile("PeriodTest")]
    public class PeriodTest : Migration
    {
...
@"
            ...
            {
                decimal notPresentIndexesCount = 0;
                if (job.CustomFields[""PeriodicMaintenance""] == ""0"")
                    notPresentIndexesCount = 1;
...
", RuleType.PerCalculation,1);
            ...
            //    var inquiryConfiguratorService = new InquiryConfiguratorService(jobPositionRep);
