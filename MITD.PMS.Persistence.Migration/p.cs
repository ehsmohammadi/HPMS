...
", RuleType.PerCalculation, 4);
            ...
            using (var uow = uows.CurrentUnitOfWork as NHUnitOfWork)
            {
                ...
                var cft18 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                   "هدف بالای نمره شاخصهای عمومی بازرس فنی", "TechnicalInspectorFinalGeneralUpperTarget", 0, 20, EntityTypeEnum.Job, "string");
                cftRep.Add(cft18);
                //jobCftList.Add(cft18);

                //var cft19 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                //   "هدف پایین نمره شاخصهای عمومی بازرس فنی", "TechnicalInspectorFinalGeneralLowerTarget", 0, 20, EntityTypeEnum.Job, "string");
                //cftRep.Add(cft19);
                //jobCftList.Add(cft19);

                //var cft20 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                //   "هدف بالای نمره شاخصهای تخصصی بازرس فنی", "TechnicalInspectorFinalTechnicalUpperTarget", 0, 80, EntityTypeEnum.Job, "string");
                //cftRep.Add(cft20);
                //jobCftList.Add(cft20);

                //var cft21 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                //   "هدف بالای نمره شاخص فرهنگ و تعهد سازمانی", "OrganizationalCultureAndCommitmentUpperTarget", 0, 100, EntityTypeEnum.Job, "string");
                //cftRep.Add(cft21);
                //jobCftList.Add(cft21);

                //var cft22 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                //   "هدف پایین نمره شاخص فرهنگ و تعهد سازمانی", "OrganizationalCultureAndCommitmentLowerTarget", 0, 100, EntityTypeEnum.Job, "string");
                //cftRep.Add(cft22);
                //jobCftList.Add(cft22);

                //var cft23 = new PMSAdmin.Domain.Model.CustomFieldTypes.CustomFieldType(cftRep.GetNextId(),
                //   "هدف پایین نمره شاخص مدت زمان Off HIRE فني", "TechnicalOffHireTimeLowerTarget", 0, 100, EntityTypeEnum.Job, "string");
                //cftRep.Add(cft23);
                //jobCftList.Add(cft23);
                ...
                var job3 = new PMSAdmin.Domain.Model.Jobs.Job(jobRep.GetNextId(),
                        "کارشناس خرید و سفارشات فنی", "ExpertOfPurchasingAndTechnicalOrders");
                jobRep.AddJob(job3);
                jobList.Add(job3);

                var job4 = new PMSAdmin.Domain.Model.Jobs.Job(jobRep.GetNextId(),
                        "مهندس ناظر برق", "ElectricalSupervisorEngineer");
                jobRep.AddJob(job4);
                jobList.Add(job4);

                var job5 = new PMSAdmin.Domain.Model.Jobs.Job(jobRep.GetNextId(),
                        "مهندس ناظر الکترونیک", "ElectronicsSupervisorEngineer");
                jobRep.AddJob(job5);
                jobList.Add(job5);
                ...
                var jobPosition2 = new PMSAdmin.Domain.Model.JobPositions.JobPosition(jobPositionRep.GetNextId(),
                        "مهندس ناظر الکترونیک", "ElectronicsSupervisorEngineerJobPosition");
                jobPositionRep.Add(jobPosition2);

                var jobPosition3 = new PMSAdmin.Domain.Model.JobPositions.JobPosition(jobPositionRep.GetNextId(),
                        "مهندس ناظر برق", "ElectricalSupervisorEngineerJobPosition");
                jobPositionRep.Add(jobPosition3);

                var jobPosition4 = new PMSAdmin.Domain.Model.JobPositions.JobPosition(jobPositionRep.GetNextId(),
                        "کارشناس خرید و سفارشات فنی", "ExpertOfPurchasingAndTechnicalOrdersJobPosition");
                jobPositionRep.Add(jobPosition4);
