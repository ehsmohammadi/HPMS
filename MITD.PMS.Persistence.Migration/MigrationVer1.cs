...
namespace MITD.PMS.Persistence
{
    ...
    public class MigrationVer1 : Migration
    {
        ...
        private void createInquiryTable()
        {
            ...
            Create.Table("Unit_InquiryConfigurationItems")
                .WithColumn("Id").AsInt64().PrimaryKey()
        ...
        private void createEmployees()
        {
            ...
            Create.Table("Employees_Units")
                ...
                .WithColumn("PeriodUnitId").AsInt64()
                .ForeignKey("Periods_Units", "Id")
            ...
            Create.Table("Employees_UnitCustomField_Values")
              .WithColumn("Id").AsInt64().PrimaryKey()
              .WithColumn("RowVersion").AsCustom("rowversion")

              .WithColumn("EmployeeUnitId").AsInt64().Nullable()
              .ForeignKey("Employees_Units", "Id")

              .WithColumn("PeriodUnitCustomFieldTypeId").AsInt64()
              .ForeignKey("Periods_Units_CustomFields", "Id")
