    ...
    public class ClaimsTransformer : ClaimsAuthenticationManager
    {
        ...
        public static ClaimsPrincipal CreateIncomingPrincipalDefault()
        {
            ...
            incomingPrincipal.Identities.First().AddClaims(new List<Claim>
            {
               ...
               // new Claim("http://identityserver.thinktecture.com/claims/profileclaims/employeeno", "112161"),
               new Claim("http://identityserver.thinktecture.com/claims/profileclaims/employeeno", "931639"),
