...
{
    public class ChangeEmployeepointService : IActionService<EmployeeListVM>, IActionService<SubordinatesConfirmationVM>
    {
        ...
        public void DoAction(SubordinatesConfirmationVM vm)
        {
            employeeService.GetEmployee((res, exp) => pmsController.BeginInvokeOnDispatcher(() =>
           {
               if (exp == null)
