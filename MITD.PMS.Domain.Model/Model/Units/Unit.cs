...
namespace MITD.PMS.Domain.Model.Units
{
    public class Unit : EntityWithDbId<long,UnitId>, IEntity<Unit>
    {
        ...
        public virtual void AddCustomInquirer(EmployeeIdWithUnitId inquirer, Employee inquirySubject)
        {
            configurationItemList.Add(
                new UnitInquiryConfigurationItem(
                    new UnitInquiryConfigurationItemId(inquirer.UnitId, inquirer.EmployeeId, Id),
                    this, false, true)); // JobPositionLevel.None));
        }
        public virtual void AddCustomInquirer(EmployeeId employeeId)//, UnitId emploeeyUnitId)
        {
            configurationItemList.Add(
                new UnitInquiryConfigurationItem(
                    new UnitInquiryConfigurationItemId(null, employeeId, Id),
                    this, false, true)); // JobPositionLevel.None));
        }

        public virtual void UpdateInquirersBy(Employee inquirySubject)
        {
           AddCustomInquirer(inquirySubject.Id); 
        }
