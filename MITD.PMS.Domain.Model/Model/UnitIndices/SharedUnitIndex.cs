...
{
    public class SharedUnitIndex: IEntity<SharedUnitIndex>
    { 
        #region Fields
        ...
        private readonly SharedUnitIndexId id;
        public virtual SharedUnitIndexId Id
        {
            get { return id; }
        ...
        #region Constructors
        protected SharedUnitIndex()
        {
           //For OR mapper
        }

        public SharedUnitIndex(SharedUnitIndexId id, 
                           string name, 
        ...
        public virtual bool SameIdentityAs(SharedUnitIndex other)
        {
