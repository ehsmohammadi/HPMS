...
{
    public class EmployeeClaimListVM : PeriodMgtWorkSpaceViewModel
        , IEventHandler<UpdateClaimListArgs>
    {
        ...
        public ClaimDTOWithAction SelectedClaim
        {
            ...
            set
            {
                ...
                if (View != null)
                    ((IEmployeeClaimListView)View).CreateContextMenu(new ReadOnlyCollection<DataGridCommandViewModel>(ClaimCommands));
            }
        }
        ...
        public EmployeeClaimListVM(IPMSController appController,
        ...
        public void Load(PeriodDTO periodParam, string employeeNo)
        {
            period = periodParam;
        ...
        private void refresh()
        {
            ...
            claimService.GetAllClaim(
                ...
                }), period.Id, employeeNo, claims.PageSize, claims.PageIndex + 1);
        }
        ...
        {
            if (eventData.EmployeeNo == employeeNo)
                refresh();
        }
