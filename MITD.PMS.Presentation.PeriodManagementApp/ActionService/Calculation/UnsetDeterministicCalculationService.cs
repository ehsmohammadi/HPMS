...
{
    public class UnsetDeterministicCalculationService : IActionService<CalculationListVM>
    {
        ...
        public UnsetDeterministicCalculationService(IPMSController pmsController, ICalculationServiceWrapper calculationService, IPeriodController periodController)
        {
        ...
        public void DoAction(CalculationListVM vm)
        {
            ...
            if(pmsController.ShowConfirmationBox("آیا می خواهید محاسبه انجام شده را غیر قطعی کنید؟","غیر قطعی کردن محاسبه"))
            {
                ...
                calculationService.GetCalculation((calc, exp) => pmsController.BeginInvokeOnDispatcher(() =>
                {
                    ...
                    else
                    {
                        ...
                        calculationService.ChangeDeterministicCalculation((expUpdate) => pmsController.BeginInvokeOnDispatcher(() =>
                        {
                            ...
                            {
                                pmsController.ShowMessage("محاسبه انتخاب شده غیر قطعی گردید");
