    ...
    public class BootStrapper : IBootStrapper
    {
        public void Execute()
        {
            ...
            ModuleConfigHelper.ConfigureActionModule<IActionService>(new Dictionary<int, Type>
            {
                ...
                {(int) ActionType.ManageUnitInPeriod, typeof (ManageUnitInPeriodService)},
                {(int) ActionType.ManageJobInPeriod, typeof (ManageJobInPeriodService)},
                {(int) ActionType.ManageJobIndexInPeriod, typeof (ManageJobIndexInPeriodService)},
                {(int) ActionType.ManageUnitIndexInPeriod, typeof (ManageUnitIndexInPeriodService)},
                {(int) ActionType.ManageJobPositionInPeriod, typeof (ManageJobPositionInPeriodService)},
               ...
               // {(int) ActionType.CopyPeriodBasicData, typeof (BasicDataCopyService)}, for removing copy
                ...
                {(int) ActionType.ManageUnitInPeriodVerifier, typeof (ManageUnitInPeriodVerifierService)},
